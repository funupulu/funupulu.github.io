...
arrow.forEach(arr => {
  arr.addEventListener('click', () => {
    ...
    if(arr.parentElement.parentElement.nextElementSibling.classList.contains('hide')) {
      arr.parentElement.parentElement.nextElementSibling.classList.remove('hide')
    } else {
      arr.parentElement.parentElement.nextElementSibling.classList.add('hide')
